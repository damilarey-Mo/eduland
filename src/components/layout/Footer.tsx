...
export default function Footer() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    // Handle newsletter signup (would connect to your backend in a real implementation)
    alert(`Thank you for subscribing with email: ${email}`);
    setEmail('');
  };

  return (
    <footer className="bg-gray-1000" aria-labelledby="footer-heading">
      ...
      <div className="mx-auto max-w-7xl px-6 pb-8 pt-16 sm:pt-20 lg:px-8">
            ...
            <div>
              ...
              <form onSubmit={handleSubmit} className="mt-6">
                <div className="flex max-w-md gap-x-4">
                  ...
                  <input
                    ...
                    className="min-w-0 flex-auto rounded-md border-0 bg-gray-800 px-3.5 py-2 text-white shadow-sm ring-1 ring-inset ring-gray-700 focus:ring-2 focus:ring-inset focus:ring-primary-500 sm:text-sm sm:leading-6"
                  ...
                  <motion.button
                    ...
                    whileTap={{ scale: 0.95 }}
                    className="flex-none rounded-md bg-secondary-400 px-3.5 py-2.5 text-sm font-semibold text-gray-800 shadow-sm hover:bg-secondary-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-secondary-400"
                  >
                    Subscribe
                  </motion.button>
                </div>
              ...
              <div className="mt-8">
                ...
                <address className="mt-2 not-italic text-sm text-gray-300">
                  ...
                  <p className="mt-2">
                    <a href="tel:+1-555-123-4567" className="hover:text-white">+1 (555) 665-4567</a>
                  </p>
                  <p>
                    <a href="mailto:info@eduland.edu" className="hover:text-white">info@eduland.edu</a>
                  </p>
                </address>
              </div>
            </div>
        ...
        <div className="mt-16 border-t border-gray-800/50 pt-8 sm:mt-20 md:flex md:items-center md:justify-between">
          ...
          <div className="mt-4 flex space-x-6 md:mt-0">
            ...
            <Link href="/cookies" className="text-xs leading-5 text-gray-400 hover:text-gray-300">
              Cookie Policy
            </Link>
          </div>
        </div>
