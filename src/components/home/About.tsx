        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          >
            <motion.div variants={item} className="flex items-center">
              <div className="h-1 w-12 rounded bg-primary-600"></div>
              <span className="ml-4 text-sm font-semibold uppercase tracking-wide text-primary-600">About EduLand</span>
            </motion.div>
            
            <motion.h2 
              variants={item}
              className="mt-6 text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl font-display"
            >
            ...
            <motion.ul variants={item} className="mt-8 space-y-3 text-gray-600">
              {[
                ...
                <motion.li 
                  ...
                  variants={item}
                >
                  <span className="mr-2 flex h-6 w-6 items-center justify-center rounded-full bg-primary-100 text-primary-600">
            ...
            >
              <Link
                href="/about"
                className="group inline-flex items-center gap-x-2 rounded-full bg-primary-600 px-6 py-3 text-sm font-semibold text-white shadow-sm hover:bg-primary-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary-600"
              >
                Learn more about us
