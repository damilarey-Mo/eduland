...
export default function AdminLoginPage() {
  ...
  const [success, setSuccess] = useState<string | null>(
    registered ? 'Admin account registered successfully! Please log in.' : null
  );
    ...
    <div className="min-h-screen bg-black text-white py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md mx-auto">
        <div className="text-center mb-8">
          ...
          <p className="mt-2 text-gray-400">Sign in to access admin controls</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6 bg-gray-900/50 border border-gray-800 rounded-lg p-6 shadow-xl">
          ...
          <div className="pt-4 mt-4 border-t border-gray-800">
            <div className="text-center">
              <Link href="/agent-login" className="text-sm text-gray-400 hover:text-gray-300">
                Agent login
              </Link>
